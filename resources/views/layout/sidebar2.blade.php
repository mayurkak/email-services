...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <h6 class="collapse-header">My Survey:</h6>
                    ...
                    <a class="collapse-item" href="{{ route('share')}}">Share</a>
...
<li class="nav-item">
    ...
    <div id="collapsethree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">My Survey:</h6>
                    <a class="collapse-item" href="{{ url('contact')}}">Contact</a>
                    <a class="collapse-item" href="#">Send Email List</a>
                    <a class="collapse-item" href="#">Send Sms List</a>
        </div>
    </div>
</li>
<!-- <li class="nav-item">
