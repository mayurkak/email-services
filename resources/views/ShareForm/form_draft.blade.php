            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Select Email Addresses</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        <form id="emailForm" action="{{ route('share_form', ['id' => ':id']) }}">
                            @foreach($contact as $cont)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="emails[]" value="{{$cont->email}}" id="email{{$loop->index}}">
                                    <label class="form-check-label" for="email{{$loop->index}}">
                                        {{$cont->email}}
                                    </label>
                                </div>
                            @endforeach
                            <button type="button" class="btn btn-primary" id="sendFormButton" data-id="{{ $templateForm->id }}">Submit</button>
                        </form>
                    </div>
                                        ...
                                        <div class="col-12">
                                            <form action="{{ route('store_response') }}" method="post" class="custom-form" id="formTemplate">
                                                ...
                                                <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-grid">
                                                            <button type="submit" class="btn btn-primary" name="action" value="save" data-id="{{ $template->id }}">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                            @auth
                                                <button type="button" class="btn btn-secondary"  data-id="{{ $templateForm->id }}" data-toggle="modal" data-target="#emailModal">Send Form</button>
                                            @endauth
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    var templateFormId = this.getAttribute('data-id');
    var action = form.getAttribute('action').replace(':id', templateFormId);
