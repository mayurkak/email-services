...
<body>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#questionsModal">
        Add Questions
    </button>
    ...
    <section class="py-3 py-md-5 py-xl-8 new">
        <div class="container">
            <div class="row">
                <div class="">
                    <div class="col-12">
                                ...
                                <div class="row gy-3 gy-md-4 gy-lg-0">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="row align-items-lg-center h-100">
                                            <div class="col-12">
                                                <form action="{{ route('form.save')}}" method="post" class="custom-form"
                                                    id="formTemplate">
                                                    @csrf
                                                    <input type="hidden" name="form_id" value="{{ $template->id }}">
                                                    <input type="hidden" name="form_name"
                                                        value="{{ $template->form_name }}">
                                                    <p>Template ID: {{ $template->id }}</p>
                                                    <p>Template Name: {{ $template->form_name }}</p>
                                                    <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="d-grid">                                                                
                                                                <button type="submit" class="btn btn-primary" id="save" name="action" {{ $template->id }} 
